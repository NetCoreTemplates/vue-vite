...
fs.writeFileSync(`${DIST}/_redirects`,
    fs.readFileSync(`${DIST}/_redirects`, 'utf-8').replace(new RegExp('\\$DEPLOY_API','g'),DEPLOY_API))
...
console.log('post.build.js', 'DEPLOY_API:', DEPLOY_API, 'DEPLOY_CDN:', DEPLOY_CDN
    ...
    , '_replace:', redirects_contents.replace(new RegExp('\\$DEPLOY_API','g'),DEPLOY_API)
